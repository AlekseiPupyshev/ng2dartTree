library angular2.src.forms.directives.ng_form_control.ng_deps.dart;
...
void initReflector() {
  ...
  _visited = true;
  _ngRef.reflector
    ..registerType(NgFormControl, new _ngRef.ReflectionInfo(const [
      const Directive(
        ...
        (QueryList<NgValidator> ngValidators) =>
            new NgFormControl(ngValidators)))
    ..registerSetters(
        {'form': (o, v) => o.form = v, 'model': (o, v) => o.model = v})
