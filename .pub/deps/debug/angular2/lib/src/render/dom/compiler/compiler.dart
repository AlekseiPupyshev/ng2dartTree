...
class DomCompiler extends RenderCompiler {
  ...
  DomCompiler(this._stepFactory, this._viewLoader, this._sharedStylesHost)
      : super() {
  ...
  Future<RenderProtoViewMergeMapping> mergeProtoViewsRecursively(
    ...
    return PromiseWrapper
        .resolve(pvm.mergeProtoViewsRecursively(protoViewRefs));
  }
...
class DefaultDomCompiler extends DomCompiler {
  DefaultDomCompiler(Parser parser, ViewLoader viewLoader,
