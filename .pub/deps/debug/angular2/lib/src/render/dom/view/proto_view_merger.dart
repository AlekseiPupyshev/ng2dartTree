...
RenderProtoViewMergeMapping mergeProtoViewsRecursively(
  ...
  var mergedProtoView = DomProtoView.create(mainProtoView.original.type,
      rootElement, mainProtoView.original.encapsulation, fragmentsRootNodeCount,
...
cloneProtoViews(
  ...
  targetClonedProtoViews.add(cloneAndQueryProtoView(hostProtoView, false));
